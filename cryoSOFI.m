...
if nargin >1
    ...
    elseif strcmpi(type, 'cross')
        ...
        output = struct('average', average, 'averageDeconv', averageDeconv, 'AC2', AC2, 'AC3', AC3, 'AG4', AG4, 'AC4', AC4,...
            ...
            'XC2deconv', XC2deconv, 'XC3deconv', XC3deconv,'XG4deconv', XG4deconv,'XC4deconv',XC4deconv, 'measuredPSFstd', measuredPSFstd, 'dRegistered', d);
    end
...
for k = 1:size(tau,1)
    AC2 = AC2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    AC3 = AC3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    AG4 = AG4 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)).*delta(i,j,t+tau(k,4)),3))/size(tau,1);
    AG4_12 = AG4_12 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    AG4_13 = AG4_13 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    AG4_14 = AG4_14 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,4)),3))/size(tau,1);
    AG4_23 = AG4_23 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    AG4_24 = AG4_24 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,4)),3))/size(tau,1);
    AG4_34 = AG4_34 + abs(mean(delta(i,j,t+tau(k,3)).*delta(i,j,t+tau(k,4)),3))/size(tau,1);
end
...
for k=1:size(tau,1)
    AC2 = AC2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XC2hor = XC2hor + abs(mean(delta(i,j-1,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XC2vert = XC2vert +abs(mean(delta(i-1,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)),3))/size(tau,1);
    XC2diag1 = XC2diag1+ abs(mean(delta(i-1,j-1,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)),3))/size(tau,1);
    XC2diag2 = XC2diag2 +abs(mean(delta(i-1,j+1,t+tau(k,1)).*delta(i+1,j-1,t+tau(k,2)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XC2Central = XC2Central + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XC2Horizontal = XC2Horizontal + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XC2Vertical = XC2Vertical + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)),3))/size(tau,1);
    XC2Diagonal1 = XC2Diagonal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)),3))/size(tau,1);
    XC2Diagonal2 = XC2Diagonal2 + abs(mean(delta(i,j+1,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XC3Central = XC3Central + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XC3Horizontal1 = XC3Horizontal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XC3Horizontal2 = XC3Horizontal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XC3Vertical1 = XC3Vertical1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XC3Vertical2 =  XC3Vertical2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XC3Diagonal1 = XC3Diagonal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XC3Diagonal2 = XC3Diagonal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XC3Diagonal3 = XC3Diagonal3 + abs(mean(delta(i,j+1,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XC3Diagonal4 = XC3Diagonal4 + abs(mean(delta(i,j+1,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4Central = XG4Central + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4Horizontal1 = XG4Horizontal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4Horizontal2 = XG4Horizontal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4Horizontal3 = XG4Horizontal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4Vertical1 = XG4Vertical1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Vertical2 = XG4Vertical2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Vertical3 = XG4Vertical3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal1 = XG4Diagonal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal2 = XG4Diagonal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal3 = XG4Diagonal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal4 = XG4Diagonal4 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal5 = XG4Diagonal5 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal6 = XG4Diagonal6 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal7 = XG4Diagonal7 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal8 = XG4Diagonal8 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4Diagonal9 = XG4Diagonal9 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4_12_Central = XG4_12_Central + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Horizontal1 = XG4_12_Horizontal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Horizontal2 = XG4_12_Horizontal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Horizontal3 = XG4_12_Horizontal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Vertical1 = XG4_12_Vertical1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Vertical2 = XG4_12_Vertical2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Vertical3 = XG4_12_Vertical3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal1 = XG4_12_Diagonal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal2 = XG4_12_Diagonal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal3 = XG4_12_Diagonal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal4 = XG4_12_Diagonal4 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal5 = XG4_12_Diagonal5 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal6 = XG4_12_Diagonal6 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal7 = XG4_12_Diagonal7 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal8 = XG4_12_Diagonal8 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)),3))/size(tau,1);
    XG4_12_Diagonal9 = XG4_12_Diagonal9 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,2)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4_13_Central = XG4_13_Central + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Horizontal1 = XG4_13_Horizontal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Horizontal2 = XG4_13_Horizontal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Horizontal3 = XG4_13_Horizontal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Vertical1 = XG4_13_Vertical1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Vertical2 = XG4_13_Vertical2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Vertical3 = XG4_13_Vertical3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal1 = XG4_13_Diagonal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal2 = XG4_13_Diagonal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal3 = XG4_13_Diagonal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal4 = XG4_13_Diagonal4 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal5 = XG4_13_Diagonal5 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal6 = XG4_13_Diagonal6 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal7 = XG4_13_Diagonal7 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal8 = XG4_13_Diagonal8 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_13_Diagonal9 = XG4_13_Diagonal9 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4_14_Central = XG4_14_Central + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Horizontal1 = XG4_14_Horizontal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Horizontal2 = XG4_14_Horizontal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Horizontal3 = XG4_14_Horizontal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Vertical1 = XG4_14_Vertical1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Vertical2 = XG4_14_Vertical2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Vertical3 = XG4_14_Vertical3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal1 = XG4_14_Diagonal1 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal2 = XG4_14_Diagonal2 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal3 = XG4_14_Diagonal3 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal4 = XG4_14_Diagonal4 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal5 = XG4_14_Diagonal5 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal6 = XG4_14_Diagonal6 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal7 = XG4_14_Diagonal7 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal8 = XG4_14_Diagonal8 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_14_Diagonal9 = XG4_14_Diagonal9 + abs(mean(delta(i,j,t+tau(k,1)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4_23_Central = XG4_23_Central + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Horizontal1 = XG4_23_Horizontal1 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Horizontal2 = XG4_23_Horizontal2 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Horizontal3 = XG4_23_Horizontal3 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Vertical1 = XG4_23_Vertical1 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Vertical2 = XG4_23_Vertical2 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Vertical3 = XG4_23_Vertical3 + abs(mean(delta(i+1,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal1 = XG4_23_Diagonal1 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal2 = XG4_23_Diagonal2 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal3 = XG4_23_Diagonal3 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal4 = XG4_23_Diagonal4 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal5 = XG4_23_Diagonal5 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal6 = XG4_23_Diagonal6 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal7 = XG4_23_Diagonal7 + abs(mean(delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal8 = XG4_23_Diagonal8 + abs(mean(delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
    XG4_23_Diagonal9 = XG4_23_Diagonal9 + abs(mean(delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,3)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4_24_Central = XG4_24_Central + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Horizontal1 = XG4_24_Horizontal1 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Horizontal2 = XG4_24_Horizontal2 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Horizontal3 = XG4_24_Horizontal3 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Vertical1 = XG4_24_Vertical1 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Vertical2 = XG4_24_Vertical2 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Vertical3 = XG4_24_Vertical3 + abs(mean(delta(i+1,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal1 = XG4_24_Diagonal1 + abs(mean(delta(i,j,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal2 = XG4_24_Diagonal2 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal3 = XG4_24_Diagonal3 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal4 = XG4_24_Diagonal4 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal5 = XG4_24_Diagonal5 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal6 = XG4_24_Diagonal6 + abs(mean(delta(i,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal7 = XG4_24_Diagonal7 + abs(mean(delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal8 = XG4_24_Diagonal8 + abs(mean(delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_24_Diagonal9 = XG4_24_Diagonal9 + abs(mean(delta(i+1,j+1,t+tau(k,2)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
end
...
for k = 1:size(tau,1)
    XG4_34_Central = XG4_34_Central + abs(mean(delta(i,j,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Horizontal1 = XG4_34_Horizontal1 + abs(mean(delta(i,j,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Horizontal2 = XG4_34_Horizontal2 + abs(mean(delta(i,j+1,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Horizontal3 = XG4_34_Horizontal3 + abs(mean(delta(i,j+1,t+tau(k,3)).*delta(i,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Vertical1 = XG4_34_Vertical1 + abs(mean(delta(i,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Vertical2 = XG4_34_Vertical2 + abs(mean(delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Vertical3 = XG4_34_Vertical3 + abs(mean(delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal1 = XG4_34_Diagonal1 + abs(mean(delta(i,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal2 = XG4_34_Diagonal2 + abs(mean(delta(i,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal3 = XG4_34_Diagonal3 + abs(mean(delta(i,j+1,t+tau(k,3)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal4 = XG4_34_Diagonal4 + abs(mean(delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal5 = XG4_34_Diagonal5 + abs(mean(delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal6 = XG4_34_Diagonal6 + abs(mean(delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal7 = XG4_34_Diagonal7 + abs(mean(delta(i+1,j,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal8 = XG4_34_Diagonal8 + abs(mean(delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j,t+tau(k,4)),3))/size(tau,1);
    XG4_34_Diagonal9 = XG4_34_Diagonal9 + abs(mean(delta(i+1,j+1,t+tau(k,3)).*delta(i+1,j+1,t+tau(k,4)),3))/size(tau,1);
end
